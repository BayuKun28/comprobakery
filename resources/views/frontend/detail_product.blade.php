                ...
                <div class="col-lg-6">
                    <div class="product__details__img">
                        <div class="product__details__big__img">
                            <img class="big_img" src="{{ asset('cake-main/') }}/img/shop/details/product-big-1.jpg"
                                alt="">
                        </div>
                        <div class="product__details__thumb">
                            <div class="pt__item active">
                                <img data-imgbigurl="{{ asset('cake-main/') }}/img/shop/details/product-big-2.jpg"
                                    src="{{ asset('cake-main/') }}/img/shop/details/product-big-2.jpg" alt="">
                            </div>
                            <div class="pt__item">
                                <img data-imgbigurl="{{ asset('cake-main/') }}/img/shop/details/product-big-1.jpg"
                                    src="{{ asset('cake-main/') }}/img/shop/details/product-big-1.jpg" alt="">
                            </div>
                            <div class="pt__item">
                                <img data-imgbigurl="{{ asset('cake-main/') }}/img/shop/details/product-big-4.jpg"
                                    src="{{ asset('cake-main/') }}/img/shop/details/product-big-4.jpg" alt="">
                            </div>
                            <div class="pt__item">
                                <img data-imgbigurl="{{ asset('cake-main/') }}/img/shop/details/product-big-3.jpg"
                                    src="{{ asset('cake-main/') }}/img/shop/details/product-big-3.jpg" alt="">
                            </div>
                            <div class="pt__item">
                                <img data-imgbigurl="{{ asset('cake-main/') }}/img/shop/details/product-big-5.jpg"
                                    src="{{ asset('cake-main/') }}/img/shop/details/product-big-5.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__option">
                            <a href="#" class="primary-btn"><i class="fa fa-whatsapp" aria-hidden="true"></i>
                                Whatsapp</a>
                        </div>
                    </div>
                </div>
